...
def get_tickers() -> str:
    """Prompt the user to select or enter a ticker symbol, with an option to use the Scout scanner."""
    use_scout_answer = questionary.select(
    ...
    if use_scout:
        ...
        if bullish_stocks:
            choices = bullish_stocks + ["Enter manually"]
